...
Rails.application.configure do
  ...
  # Railway/Render handle SSL termination, so we assume SSL but don't force redirect
  ...
  # Use port 465 with SSL/TLS (Render blocks port 587)
  ...
  config.hosts = [
    ...
    "api.hemline.studio",             # Your API domain
    "hemline.studio"                  # Your frontend domain
    ...
    # /^127\.0\.0\.1:\d+$/              # Allow 127.0.0.1 with any port
  ]
